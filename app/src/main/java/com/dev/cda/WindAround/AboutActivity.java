...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ll.addView(createTableRow(createTextView("1.0.0"), lp),i++);
        ll.addView(createTableRow(createTextView("developper :"), lp),i++);
        ll.addView(createTableRow(createTextView("Clément Daviller"), lp),i++);
        ll.addView(createTableRow(createTextView("mail :"), lp),i++);
        ll.addView(createTableRow(createTextView("clement.daviller@gmail.com"), lp),i++);
        ll.addView(createTableRow(createTextView("source code:"), lp),i++);
        ll.addView(createTableRow(createTextView("https://github.com/tnemelc/WindAround"), lp),i++);
    }
